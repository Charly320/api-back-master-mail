...
- **Fecha de generación:** 2026-07-21T03:14:49.390Z
...
- **Total de vulnerabilidades Dependabot:** 7
...
- **Vulnerabilidades exclusivas de desarrollo:** 5
- **Candidatas para corrección automática:** 0
- **Requieren revisión manual:** 7
- **No aplican:** 0
- **Falsos positivos:** 0
...
- **Identificador:** DEPENDABOT-8
- **Tipo:** DEPENDABOT
- **Severidad:** high
- **Descripción:** js-yaml: YAML merge-key chains can force quadratic CPU consumption
- **CVSS:** 7.5
...
js-yaml (dependencia de lint) recibirá una actualización de tipo minor. Aunque el versionado semántico sugiere compatibilidad, el mantenedor puede introducir nuevo comportamiento por defecto. Un problema en este paquete afecta únicamente al equipo de desarrollo; no llega al entorno de producción.
...
Revisar las notas de la versión de js-yaml entre 4.2.0 y 4.3.0, y luego actualizar.
...
- package-lock.json: versión instalada 1.1.16.
...
Planificar una migración dedicada para brace-expansion desde 1.1.16 hacia 2.1.2.
...
Planificar una migración dedicada para brace-expansion desde 1.1.16 hacia 5.0.7.
